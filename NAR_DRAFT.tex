...
We present \batcave (Bayesian Analysis Tools for Context-Aware Variant Evaluation), an algorithm that first learns the tumor mutational profile and then uses it as a prior for evaluating potential mutations.
...
More broadly, the algorithm can be added to other variant callers, and it can be extend to include additional biological features that affect mutation generation.
\end{abstract}
