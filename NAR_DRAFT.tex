...
The mutation profile is computed from the high probability sites, and the posterior probability of mutation is recomputed for all sites as described in Materials and Methods.
