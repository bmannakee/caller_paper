...
A naive application of Eqn. \ref{eqn:mut_rate} implies a minimum variant allele frequency of \bkmcomment{calculate this, will be very low. First pass is vaf >= $10^{-5}$}, requiring sequencing depths far in excess of current standards.
