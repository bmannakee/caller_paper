...
\subsection{Calibration metric}
  ...
  \begin{figure*}
    ...
    A perfectly calibrated model would generate the diagonal line. Precision-recall curves for real data \textbf{(e)} and \textbf{(f)}. \bkmcomment{c has better axis settings than d and move BATCAVE over a bit. fix}}
  \label{NAR-wes_fig}
  \end{figure*}
