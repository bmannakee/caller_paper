...
\rngcomment{Sample contamination by normal cells can result in underestimation of tumor mutation allele frequencies.
...
\rngcomment{Shi et al.\ estimated sample purities of between 26\% and 80\%, and we used these estimates in \texttt{batcaver}.}
...
\begin{table*}[b]
  ...
  \\
  real breast \cite{Shi2018} & Actual & 7e-7 & -- & -- & .972 & .972 & -- & --
  \\
  \botrule
  \end{tabular}%
  }
...
\begin{table*}[b]
  ...
  \\
  \colrule
  Case 1 biorep A & 53.8 & 9.27e-7 
  \\
  Case 1 biorep B & 46.3 & 8.4e-7 
  \\
  Case 1 biorep C & 26.0 & 1.02e-6 
  \\
  Case 2 biorep A & 40.0 & 1.07e-6 
  \\
  Case 2 biorep B & 32.3 & 1.04e-7 
  \\
  Case 2 biorep C & 40(*) & 9.56e-7
  \\
  Case 3 biorep A & 56.4 & 8.7e-7
  \\
  Case 3 biorep B & 72.8 & 7.37e-7 
  \\
  Case 3 biorep C & 64.9 & 4.3e-7 
  \\
  Case 4 biorep A & 60.4 & 8.75e-7 
  \\
  Case 4 biorep B & 61.7 & 7.91e-7 
  \\
  Case 4 biorep C & 57.6 & 8.14e-7 
  \\
  ...
  \\
  Case 6 biorep A & 47.8 & 2.77e-7 
  \\
  Case 6 biorep B & 49.4 & 4.08e-7 
  \\
  Case 6 biorep C & 52.9 & 4.37e-7 
  \\
  \botrule
  \end{tabular}%
  }
  {Shi et al. did not provide an estimate of purity for Case 2 biorep C. We chose .4 because it is similar to the other biological replicates from this sample.}
\end{table*}
