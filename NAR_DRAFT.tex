...
When comparing our posterior odds to those of MuTect in this paper, we use \citet{Cibulskis2013} in assuming a prior per-base probability of mutation of $3\cdot10^{-6}$.
