...
\bkmcomment{Low tumor purity can result in a distribution of reported allele frequencies that differs from the true distribution.
We suggest in cases where an estimate of tumor purity is known, such as when using the GATK 4 best practices pipeline, providing it to batcaver.}
...
\bkmcomment{We use properties of the allele frequency distribution of high-confidence mutations to estimate the mutation rate in a tumor, and copy number alterations can distort the allele frequency distribution.
