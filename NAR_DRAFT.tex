...
Replacing that constant probability with a context-aware prior would require a more complicated manipulation of the quality scores output by Strelka than we perform for MuTect, but is conceptually straightforward. \rngcomment{Is this correct, or does Strelka2 output enough for us to do it post-hoc?}
