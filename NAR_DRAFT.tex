...
\subsubsection{Estimation of the mutation signature.}
...
\subsubsection{Estimation of the mutation rate.}
...
\subsubsection{False positive rate control.}
...
\subsubsection{Tumor simulations.}

Tumor variants via a branching process to simulate neutral evolution with no death.
Variants selected from PCAWG and TCGA lists(with download dates).
We simulated 100X whole genome and 500X exome normal reads from the GRCH38 reference genome with VarSim \cite{Mu2015}, and aligned them to GRch38 with BWA \cite{Li2009a}, both with default parameters.
