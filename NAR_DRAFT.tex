...
\begin{figure}
  ...
  \rngcomment{Zoom panel B into relevant region of plot ($\sim$1000 mutations). What is notation (target || prior)?}}\bkmcomment{just saw it somewhere, change to comma.}
\label{NAR-kl_fig}
\end{figure}
