...
\bkmcomment{Depends on the cutoff. This is the precision-recall curve. I can answer this for the mutect threshold in MuTect 1.1.7. Could probably answer it for the Mutect2 threshold as well.}
...
In fact, they may be simpler to incorporate than trinucleotide context, because their effect on the prior may vary less among tumors. \rngcomment{Can we back this assertion up?} \bkmcomment{Possibly not in this strong form. Most of these citations for non tri-nucleotide context are from germline, and represent things that will happen in all replications, not just tumors. Hodgkinson and Eyre-Walker might be a usable citation here \citep{Hodgkinson2011}, but wording is awkward. May not be an assertion worth making.} 
...
Statistically, this is an empirical Bayesian approach~\cite{XXX}. \rngcomment{Add citations, and sharpen discussion if necessary.}
...
Recent studies have found differences in mutational profiles among variants of different allelic frequencies~\cite{TrackSigpaper}, although those differences are relatively small.
