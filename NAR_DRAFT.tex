...
For example, Strelka2 computes a joint posterior probability over tumor and normal genotypes, assuming a uniform probability of somatic mutation at each genomic site \cite{Kim2018}.
Replacing that uniform probability with a context-aware prior would require editing the Strelka2 source code, but is conceptually straightforward. \rngcomment{Is this correct, or does Strelka2 output enough for us to do it post-hoc?}
