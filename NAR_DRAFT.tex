...
\rngcomment{What are we doing about the multi-regional nature of this data? Are we combining across regions somehow?}
...
The Integrated Calibration Index is the average distance between the fit and that line.
\rngcomment{This can't be true, otherwise perfect calibration would be ICI=1... What is it?}
...
\begin{figure}
  ...
  \end{center}
  \caption{Convergence of the site-specific prior to the data generating distribution. Plotted is the Kullback-Leibler divergence between the estimated and simulated profiles versus number of incorporated mutations for whole exomes. Convergence for whole genomes is similar.
  \rngcomment{Omit panel B and remove A label. These are similar enough we don't need to show both.}
  }
\label{NAR-kl_fig}
\end{figure}
