...
We have chosen to implement \batcave as a post-calling algorithm for exclusive use with MuTect because MuTect presents a simple statistical model and a well-tested set of heuristic filters.
...
These are high-probability variants generated from a distribution, the mutation profile, and measured with very small error.
This data allows us to reliably estimate the distribution of substitution types.
