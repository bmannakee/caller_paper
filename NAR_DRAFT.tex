...
The first is the set of mutations that pass all heuristics filters, and a having a very large posterior probability of being present given the observed read data.
