...
The package leverages the Bioconductor packages \texttt{BSgenome}, \texttt{GenomicAlignments}, \texttt{VariantAnnotation}, and \texttt{SomaticSignatures} for fast and memory-efficient variant annotation and genomic context identification. 
