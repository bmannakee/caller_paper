...
\rngcomment{Got here...}
\bkmcomment{No currently published paper has numbered equations, and it is not mentioned in the guidelines. I am using their template for numbered equations and made all equations numbered for consistency.}
...
When comparing our posterior odds to those of MuTect in this paper, we follow Cibulskis et al., 2013~\citep{Cibulskis2013} in assuming a prior per-base probability of mutation of $3\cdot10^{-6}$.
...
\subsection{Calibration metric}
  ...
  \begin{figure*}
    ...
    \textbf{(E)}--\textbf{(F)} Precision-recall curves for real data.}
  \label{NAR-wes_fig}
  \end{figure*}
