...
%DIF ADD NAR_DRAFT.tex                   Fri Jan 10 15:20:18 2020
...
\DIFdelendFL \DIFaddbeginFL \tableparts{%
  ...
  \\
  real AML \cite{Griffith2015} & Actual & 3.6e-8 & -- & -- & .988 & .996 & -- & --
  \\
  real breast \cite{Shi2018} & Actual & 6.6e-7 & -- & -- & .968 & .972 & -- & --
  \\
  \botrule
  \end{tabular}%
  }
...
Nevertheless, for }\DIFaddend both MuTect and \batcave, the precision-recall curve is almost perfect for the validated variants (.995 \& .996 area under the curve) (Fig.~\ref{NAR-wes_fig}E and Table~\ref{table:01}).
